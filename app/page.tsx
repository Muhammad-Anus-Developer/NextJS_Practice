                    ...
                    <motion.div
                      ...
                      <div ref={index === activeIndex ? targetRef : null}
                        ...
                        <span className="p-[5px] w-[100%] flex items-center bg-transparent gap-3">
                          ...
                          />
                          <p className="text-[16px] m-0" style={index === activeIndex ? { color: '#EB3A4A', background: 'transparent' } : {
                            background: "transparent", backgroundImage: `linear-gradient(90deg, #1A1A1A 0%, #ABABAB 102.73%),
